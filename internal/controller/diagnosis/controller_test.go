...
func TestCreateDiagnosis(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expected := &diagEntity.Entity{
			Diagnosis: "gripessilla",
		}
		mockService.EXPECT().
			Create(gomock.Any(), "1234", "gripessilla", gomock.Any()).
			Return(expected, nil)
	...
	t.Run("internal error", func(t *testing.T) {
		...
		mockService.EXPECT().
			Create(gomock.Any(), "1234", "flu", gomock.Any()).
...
func TestFindDiagnosis(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockService.EXPECT().
			...
			Return([]diagEntity.Entity{{Diagnosis: "lagripe"}}, nil)
