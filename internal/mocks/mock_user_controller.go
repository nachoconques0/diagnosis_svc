...
func (m *MockUserService) GetByEmail(ctx context.Context, email, password string) (*user.Entity, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) GetByEmail(ctx, email, password any) *gomock.Call {
